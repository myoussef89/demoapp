node {
    ...
    stage('Build image') {
        ...
        app = docker.build("002096266198.dkr.ecr.us-east-1.amazonaws.com/spinnaker-registry")
    }
    ...
    stage('Push image') {
        ...
        docker.withRegistry('https://002096266198.dkr.ecr.us-east-1.amazonaws.com/spinnaker-registry', 'ecr:us-east-1:aws_ecr')    {
